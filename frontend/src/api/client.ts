...
export const api = {
  ...
  admin: {
    ...
    stats: impl.getAdminStats,
    health: impl.getAdminHealth,
    activityFeed: impl.getAdminActivityFeed,
  },
  reports: {
  ...
  announcements: {
    listMine: impl.listMyAnnouncements,
    getUnreadCount: impl.getUnreadAnnouncementCount,
    listPinned: impl.listPinnedAnnouncements,
    markRead: impl.markAnnouncementRead,
    dismiss: impl.dismissAnnouncement,
    undismiss: impl.undismissAnnouncement,
    create: impl.createAnnouncement,
    delete: impl.deleteAnnouncement,
    togglePin: impl.toggleAnnouncementPin,
    getStats: impl.getAnnouncementStats,
    toggleReaction: impl.toggleAnnouncementReaction,
    listComments: impl.listAnnouncementComments,
    addComment: impl.addAnnouncementComment,
    deleteComment: impl.deleteAnnouncementComment,
    acknowledge: impl.acknowledgeAnnouncement,
    archive: impl.archiveAnnouncement,
    unarchive: impl.unarchiveAnnouncement,
    listPendingApproval: impl.listPendingApprovalAnnouncements,
    approve: impl.approveAnnouncement,
    reject: impl.rejectAnnouncement,
    search: impl.searchAnnouncements,
    listNewSince: impl.listNewSinceAnnouncements,
    uploadImage: impl.uploadAnnouncementImage,
  },
  finance: {
