...
export default function NotificationPanel() {
  ...
  return (
    <div className="relative" ref={panelRef}>
      ...
      {/* Dropdown panel */}
      {open && (
        <div className="absolute right-0 mt-2 w-[calc(100vw-1rem)] sm:w-96 max-h-[80vh] sm:max-h-[480px] bg-white border border-gray-200 rounded-xl shadow-xl z-50 flex flex-col overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
          {/* Header */}
